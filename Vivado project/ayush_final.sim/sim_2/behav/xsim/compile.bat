...
REM
REM Generated by Vivado on Wed Sep 17 13:20:29 +0530 2025
...
echo "xvlog --incr --relax -prj tb_top_nn_vlog.prj"
call xvlog  --incr --relax -prj tb_top_nn_vlog.prj -log xvlog.log

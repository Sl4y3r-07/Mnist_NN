...
HD_PWD='C:/Users/anany/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_nn.tcl

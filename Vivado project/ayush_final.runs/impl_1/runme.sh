...
HD_PWD='C:/Users/anany/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_nn.tcl -notrace
